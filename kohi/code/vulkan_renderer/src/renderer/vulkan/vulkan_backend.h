...
b8 vulkan_renderer_set_uniform(struct shader* s,struct shader_uniform* uniform,const void* value);
...
b8 vulkan_renderer_flag_enabled(renderer_config_flags flags);
void vulkan_renderer_flag_set_enabled(renderer_config_flags flags,b8 enabled);
