...
b8 vulkan_renderer_sampler_refresh(renderer_backend_interface* plugin, k_handle* sampler, texture_filter filter, texture_repeat repeat, f32 anisotropy, u32 mip_levels);
