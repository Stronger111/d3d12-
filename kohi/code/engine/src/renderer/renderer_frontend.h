 ...
 */
void renderer_render_target_create(u8 attachment_count, render_target_attachment* attachments, renderpass* renderpass, u32 width, u32 height, render_target* out_target);
