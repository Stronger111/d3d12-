...
f32 x, f32 y, f32 w, f32 h, f32 r, f32 g, f32 b, f32 a, f32 depth, u32 stencil)
{
    out_renderpass->x = x;
    out_renderpass->y = y;
    out_renderpass->w = w;
    ...
    color_attachment.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; //Transition to after the render pass
    ...
    //Attachment used from multisampling colour attachments
