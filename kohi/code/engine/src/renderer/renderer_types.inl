...
typedef struct renderer_plugin {
     ...
     */
    void (*texture_create)(struct renderer_plugin* plugin,
                           const u8* pixels,
                           struct texture* texture);
     ...
     */
    b8 (*shader_create)(struct renderer_plugin* plugin, struct shader* s, const shader_config* config, renderpass* pass, u8 stage_count, const char** stage_filenames, shader_stage* stages);
    /**
