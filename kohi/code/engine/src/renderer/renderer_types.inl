...
typedef struct renderer_backend {
     ...
     */
    b8 (*shader_create)(struct shader* s, const shader_config* config, renderpass* pass, u8 stage_count, const char** stage_filenames, shader_stage* stages);
