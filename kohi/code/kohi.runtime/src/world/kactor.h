...
typedef struct  kactor_comp_staticmesh_render_data {
    ...
    staticmesh_render_data_flags_bits flags;
...
KAPI b8 kactor_staticmesh_system_initialize(u64* memory_requirement, void* state_block, const kactor_staticmesh_system_config* config);
KAPI void kactor_staticmesh_system_shutdown(struct kactor_staticmesh_system_state* state);
...
KAPI b8 kactor_comp_staticmes5h_get_render_data(struct kactor_staticmesh_system_state* state, u32 id, kactor_comp_staticmesh_render_data* out_render_data);