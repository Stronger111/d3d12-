...
b8 kactor_staticmesh_system_initialize(u64* memory_requirement, void* state_block, const kactor_staticmesh_system_config* config) {
...
void kactor_staticmesh_system_shutdown(struct kactor_staticmesh_system_state* state) {
    if (state) {
...
b8 kactor_comp_staticmesh_get_render_data(struct kactor_staticmesh_system_state* state, u32 id, kactor_comp_staticmesh_render_data* out_render_data) {
    ...
    //fileds known by other systems to fill out the reset (i.e a scene)
