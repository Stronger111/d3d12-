...
khandle hierarchy_graph_child_add(hierarchy_graph* graph, khandle parent_handle) {
    return hierarchy_graph_child_add_with_xform(graph, parent_handle, khandle_invalid());
}
