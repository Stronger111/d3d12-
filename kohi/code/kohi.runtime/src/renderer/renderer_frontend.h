 ...
 */
KAPI b8 renderer_texture_resources_acquire(struct renderer_system_state* state,texture_type type,u32 width,u32 height,u8 channel_count,u8 mip_level,u16 array_size,texture_flag_bits flags,k_handle* out_renderer_texture_handle);
