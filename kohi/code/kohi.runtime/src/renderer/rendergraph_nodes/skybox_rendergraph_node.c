...
typedef struct skybox_rendergraph_node_internal_data {
    struct renderer_system_state* rendererer;
...
b8 skybox_rendergraph_node_create(struct rendergraph* graph, struct rendergraph_node* self, const rendergraph_node_config* config) {
    if (!self) {
