...
b8 render_view_pick_on_registered(struct render_view* self) {
    if (self) {
        ...
        // Extract uniform locations.
        data->terrain_shader_info.id_colour_location = shader_system_uniform_location(data->world_shader_info.s, "id_colour");
        data->terrain_shader_info.model_location = shader_system_uniform_location(data->world_shader_info.s, "model");
        data->terrain_shader_info.projection_location = shader_system_uniform_location(data->world_shader_info.s, "projection");
        data->terrain_shader_info.view_location = shader_system_uniform_location(data->world_shader_info.s, "view");
