 ...
 */
KAPI kaudio_attenuation_model string_to_kaudio_attenuation_model(const char* str);
 ...
 */
KAPI const char* kaudio_attenuation_model_to_string(kaudio_attenuation_model model);
