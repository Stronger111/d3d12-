...
KAPI const char* material_map_channel_to_string(kasset_material_texture_map channel);

KAPI kasset_material_texture_map string_to_material_map_channel(const char* str);