...
static b8 extract_frequency_uniforms(shader_update_frequency frequency, f32 frequency_uniform_count, kson_array* frequency_array, kasset_shader* typed_asset, u32* uniform_index);
