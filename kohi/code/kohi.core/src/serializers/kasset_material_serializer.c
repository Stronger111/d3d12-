...
static b8 extract_input_map_channel_or_vec4(const kson_object* inputs_obj, const char* input_name, b8* out_enabled, kasset_material_texture* out_map, vec4* out_value, vec4 default_value);
static b8 extract_input_map_channel_or_vec3(const kson_object* inputs_obj, const char* input_name, b8* out_enabled, kasset_material_texture* out_map, vec3* out_value, vec3 default_value);
