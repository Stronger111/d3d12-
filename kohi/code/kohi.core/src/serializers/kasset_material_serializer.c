...
static b8 extract_input_map_channel_for_float(const kson_object* inputs_obj, const char* input_name, kasset_material_texture_map map, kasset_material_texture* out_texture, kasset_material_texture_map_channel* out_source_channel, f32* out_value, f32 default_value);
