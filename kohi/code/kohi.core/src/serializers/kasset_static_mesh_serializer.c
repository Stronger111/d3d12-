...
void* kasset_static_mesh_serialize(const kasset_static_mesh* asset, u64* out_size) {
    if (!asset) {
...
b8 kasset_static_mesh_deserialize(u64 size, const void* in_block, kasset_static_mesh* out_asset) {
