...
# Detect OS and architecture.-Werror
ifeq ($(OS),Windows_NT)
# WIN32
...
# Also delete versioned PDB files (e.g. assembly_1234.pdb) generated by the linker.
	@if exist $(BUILD_DIR)\$(ASSEMBLY)_*.pdb del $(BUILD_DIR)\$(ASSEMBLY)_*.pdb
