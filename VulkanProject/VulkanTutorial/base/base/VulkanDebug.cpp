...
namespace vks
{
...
#if defined(__ANDROID__)  //Andorid平台如何运行的打包
	...
	namespace debugmarker
	{
		...
		void setObjectTag(VkDevice device, uint16_t object, VkDebugReportObjectTypeEXT objectType, uint16_t name, size_t tagSize, const void* tag)
		{
			// Check for valid function pointer (may not be present if not running in a debugging application)
