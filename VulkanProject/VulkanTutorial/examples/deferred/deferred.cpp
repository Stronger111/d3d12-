...
public:
	...
	//One sampler for the frame buffer color attachment
	VkSampler colorSampler;

	VkCommandBuffer offScreenCmdBuffer = VK_NULL_HANDLE;

	//Semaphore used to synchronize between offscreen and final scenen rendering
	...
	void prepareOffscreenFramebuffer()
	{
		...
		//Set up separete renderpass with references to the color and depth attachments
	...
	void preparePipelines()
	{
	 ...
	 //Prepare and initialize uniform buffer containing shader uniform 
	...
	void draw()
	{
		...
		//has been submitted by the application
